...
public class UIPlane extends Actor{
    ...
    public UIPlane(int x, int y, Color color){
        this.x = x;
        this.y = y;
        elements = new HashMap<Actor, double[]>();
    ...
    public UIPlane(World cover, Color color){
        x = cover.getWidth();
        y = cover.getHeight();
        elements = new HashMap<Actor, double[]>();
        GreenfootImage image = new GreenfootImage(x, y);
    ...
    public UIPlane(int x, int y, GreenfootImage image){
        this.x = x;
        this.y = y;
        elements = new HashMap<Actor, double[]>();
        setImage(image);
    ...
    public UIPlane(World cover, GreenfootImage image){
        x = cover.getWidth();
        y = cover.getHeight();
        elements = new HashMap<Actor, double[]>();
        setImage(image);
