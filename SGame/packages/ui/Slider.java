...
public class Slider extends Actor{
    ...
    private void setup(){
        ...
        slideVector = new Vector(0, length, true);
    }
    ...
    public void setRotation(int angle){
        ...
        slideVector = new Vector(angle, length, true);
        setValue(oldValue);
    }
    @Override
    ...
    public void setValue(double value){
        ...
        try{
            handle.setLocation(
                minX() + (int)(percentage * slideVector.getX()),
                minY() + (int)(percentage * slideVector.getY())
            );
        }catch(Exception e){}
    }
    
    public int minX(){
        return getX() - (int)(slideVector.getX() * 0.5);
    }
    public int minY(){
        return getY() - (int)(slideVector.getY() * 0.5);
    }
    public int maxX(){
        return getX() + (int)(slideVector.getX() * 0.5);
    }
        ...
        public void run(){
            ...
            if(offset != null){
                try{
                    ...
                    setLocation(mouse.getX() + (int)offset.getX(), mouse.getY() + (int)offset.getY());
